...
class Graficas_Espacio_de_trabajo():

    def grafica_workspace_2g_abajo(self):
        fig, ax = plt.subplots()
        #Dimensiones
        L1=0.094
        L2=0.262
    ...
    def grafica_workspace_2g_arriba(self):
        fig, ax = plt.subplots()
        #Dimensiones
        L1=0.094
        L2=0.262
    ...
    def grafica_workspace_3g_abajo(self):
        fig, ax = plt.subplots()
        ...
        ax.set_title("Espacio de Trabajo 3GDL Codo Abajo", loc="center", fontdict={'fontsize':14,'fontweight':'bold', 'color':'tab:blue'}) 
        ax.plot(x, z,color= 'tab:red')
        ax.plot(x1,z1,color= 'tab:red')
        ax.plot(x2,z2,color= 'tab:red')
    ...
    def grafica_workspace_3g_arriba(self):
    ...
    def grafica_workspace_3g_qy(self,qy):
        fig, ax = plt.subplots()
        #Reajuste de qy:
        if qy<=90:
            qy=90-qy
